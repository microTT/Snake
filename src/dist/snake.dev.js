...
window.setTimeout(function () {
  ...
  var Snake = {
     ...
     */
    "generateNewBody": function generateNewBody() {
  ...
  var ScorePanel = {
     ...
     */
    "flushScore": function flushScore(player) {
  ...
  var GameControl = {
     ...
     */
    "calculateGameZoneCellSize": function calculateGameZoneCellSize() {
     ...
     * @return {GameControl}          返回 this 对象，即调用方法的对象本身；
     */
    "snakeGrowUp": function snakeGrowUp(position) {
     ...
     */
    "snakeRunning": function snakeRunning() {
     ...
     * @return {Array}     交换后的数组
     */
    "exchangArrayElementIndex": function exchangArrayElementIndex(array, index1, index2) {
     ...
     */
    "generateBean": function generateBean() {
     ...
     */
    "getEmptyCell": function getEmptyCell() {
     ...
     * @return {GameControl}          返回 this 对象，即调用该方法的对象本身
     */
    "putElement2Cell": function putElement2Cell(element, position) {
      var gameZoneCell = GameZone.cellSize;
     ...
     */
    "isGameOver": function isGameOver(newPosition) {
      var that = GameControl,
     ...
     */
    "isEatBean": function isEatBean(newPosition) {
